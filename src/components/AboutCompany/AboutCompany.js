            ...
            <div className="container">
                <div className="about-company-inner">
                    <div className="about-company-video-box">
                        {videoPlay ? <>
                            <iframe className="about-company-video" src="https://www.youtube.com/embed/cWEH7ftG-BQ?rel=0&showinfo=0&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </> : <>
                            <img className="about-company-video-img" src={AboutCompanyImg} alt="Vieo image" />
                            <button className="about-company-video-btn" onClick={() => {
                                setVideoPlay(true)
                            }}></button>
                        </>}
                    </div>
